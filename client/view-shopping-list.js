...
const GROCERY_ITEMS_BY_SHOPPING_LIST_ID = 'http://localhost/api/shopping/shopping-lists'
const DELETE_GROCERY_ITEM_BY_ID = 'http://localhost/api/shopping/grocery-items'
